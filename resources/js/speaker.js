export function initSpeakers() {
  ...
  addSpeakerButton?.addEventListener('click', function () {
    ...
    row.innerHTML = `
      <div class="grid grid-cols-3 gap-3 pr-[60px]">
        <input type="text" name="speaker_names[]" placeholder="Nama" class="h-[48px] w-full rounded-[8px] bg-[#E7E7E7] px-[30px] text-[17px] font-medium text-[#555] outline-none placeholder:text-[#666] focus:ring-2 focus:ring-[#263F92]/30">
        <input type="text" name="speaker_titles[]" placeholder="Jabatan" class="h-[48px] w-full rounded-[8px] bg-[#E7E7E7] px-[30px] text-[17px] font-medium text-[#555] outline-none placeholder:text-[#666] focus:ring-2 focus:ring-[#263F92]/30">
        <input type="text" name="speaker_organizations[]" placeholder="Organisasi" class="h-[48px] w-full rounded-[8px] bg-[#E7E7E7] px-[30px] text-[17px] font-medium text-[#555] outline-none placeholder:text-[#666] focus:ring-2 focus:ring-[#263F92]/30">
      </div>
  ...
  addPurposeButton?.addEventListener('click', function () {
    ...
    row.className = 'relative';
    row.innerHTML = `
      <input type="text" name="event_goals[]" placeholder="Tujuan dari Event" class="h-[48px] w-full rounded-[8px] bg-[#E7E7E7] px-[30px] pr-[60px] text-[17px] font-medium text-[#555] outline-none placeholder:text-[#666] focus:ring-2 focus:ring-[#263F92]/30">
  ...
  const firstSpeakerTitle = speakerWrapper?.querySelector('input[name="speaker_titles[]"]');
  const firstSpeakerOrganization = speakerWrapper?.querySelector('input[name="speaker_organizations[]"]');
  ...
  function checkCategory() {
    if (categorySelect && categorySelect.value === '1') {
      ...
      if (firstSpeakerTitle) firstSpeakerTitle.value = '';
      if (firstSpeakerOrganization) firstSpeakerOrganization.value = '';
