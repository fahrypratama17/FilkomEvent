function showToast(title, message, type = "error", duration = 4000) {
  ...
  toast.className = `${bgColor} w-fit max-w-[500px] relative overflow-hidden text-white px-6 py-3 rounded-lg shadow-lg transition-all duration-300 transform translate-x-full opacity-0`;
  toast.innerHTML = `
