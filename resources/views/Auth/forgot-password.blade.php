...
<title>FilkomEvent - Lupa Password</title>
</head>
...
<section>
  <div class="glassmorphism flex flex-col justify-center items-center gap-11">
    <div class="flex flex-col gap-4 justify-center items-center">
      <h1 class="text-4xl text-white font-bold">Lupa Password</h1>
      <h2 class="text-xl text-white">Masukkan email anda</h2>
    </div>
    <form method="POST" action="{{ route('forgotPassword') }}" class="mx-auto w-[80%] flex flex-col justify-center gap-2">
      @csrf
      <div class="flex flex-col justify-center gap-2">
        <label class="text-white text-lg">Email</label>
        <input name="email" class="bg-white p-2 px-4 rounded-[40px] focus:outline-none focus:ring-0 focus:ring-transparent focus:border-transparent" type="email" placeholder="email">
      </div>
