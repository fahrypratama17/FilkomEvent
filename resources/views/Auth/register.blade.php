    ...
    <div class="glassmorphism flex flex-col justify-center items-center gap-6">
      ...
      <form action="{{ route('register') }}" method="post" class="mx-auto w-[80%] flex flex-col justify-center gap-2">
        ...
        <div class="relative flex flex-col justify-center gap-2">
          ...
          <input id="password" class="bg-white p-2 px-4 pr-12 rounded-[40px] focus:outline-none focus:ring-0 focus:ring-transparent focus:border-transparent" name="password" type="password" placeholder="password">
          <button type="button" onclick="togglePassword()" class="absolute right-10 top-1/2 translate-y-1 cursor-pointer">
        ...
        <div class="relative flex flex-col justify-center gap-2">
          ...
          <input id="password_confirmation" class="bg-white p-2 px-4 rounded-[40px] focus:outline-none focus:ring-0 focus:ring-transparent focus:border-transparent" name="password_confirmation" type="password" placeholder="konfirmasi password">
          <button type="button" onclick="togglePasswordConfirmation()" class="absolute right-10 top-1/2 translate-y-1 cursor-pointer">
            <i id="eye-open-confirmation" data-lucide="eye" class="absolute inset-0 transition-all duration-300 ease-in-out opacity-100 scale-100"></i>
            <i id="eye-close-confirmation" data-lucide="eyeOff" class="absolute inset-0 transition-all duration-300 ease-in-out opacity-0 scale-75"></i>
          </button>
        </div>
