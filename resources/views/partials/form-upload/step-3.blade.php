...
<div class="form-step hidden" id="step-3">
  <div class="grid grid-cols-2 gap-x-[60px] gap-y-[26px]">
    <div class="col-span-2">
      ...
      <textarea name="short_description" placeholder="Deskripsi singkat Event" class="admin-textarea h-[116px]"></textarea>
    </div>

    <div class="col-span-2">
      <label class="admin-label">Deskripsi Lengkap:</label>
      <textarea name="description" placeholder="Definisi Event" class="admin-textarea h-[139px]"></textarea>
    </div>
    ...
    <div class="col-span-2">
      ...
      <div id="purposeWrapper" class="space-y-3">
        <div class="relative">
          <input type="text" name="event_goals[]" placeholder="Tujuan dari Event" class="admin-input pr-[60px]">
