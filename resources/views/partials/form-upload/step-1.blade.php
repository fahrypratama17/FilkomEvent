<div class="form-step" id="step-1">
  <div class="mb-12.25 flex flex-col items-center">
    <label for="image_url" id="uploadLabel" class="group relative flex min-h-50.5 w-full max-w-125 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-3xl bg-[#FF5F2A] shadow-[0_5px_4px_rgba(0,0,0,0.35)] transition hover:scale-[1.01] p-2">
    ...
    <button type="button" onclick="document.getElementById('image_url').click()" class="mt-9.75 h-12 w-143.25 rounded-full bg-[#050064] text-[17px] font-extrabold text-white">
      Unggah Poster Event
    </button>
  ...
  <div class="grid grid-cols-2 gap-x-15 gap-y-6.5">
    ...
    <div>
      ...
      <div class="relative">
        ...
        <i data-lucide="calendar-days" class="pointer-events-none absolute right-5.75 top-1/2 h-4.5 w-4.5 -translate-y-1/2 text-[#FF5F2A]"></i>
      </div>
    </div>
